...
@WebServlet("/user/unblock")
@Slf4j
public class UnblockUserServlet extends BaseUserServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            log.info("Received request to unblock user: " + requestBody);
            ...
            OperationResultDto result = userService.unblockUser(userActionRequestDto);
