...
@Slf4j
public class DeleteUserServlet extends BaseUserServlet {
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            log.info("Received request to delete user: " + requestBody);
            ...
            OperationResultDto result = userService.delete(userActionRequestDto);
