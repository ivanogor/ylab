...
import homework3.dto.GetHabitsByFrequencyDateDto;
...
@WebServlet("/habit/getByFrequency")
@Slf4j
public class GetHabitsByFrequencyServlet extends BaseHabitServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            log.info("Received request to get habits by frequency: " + requestBody);

            // Десериализация тела запроса
            GetHabitsByFrequencyDateDto getHabitsByFrequencyDateDto = objectMapper.readValue(requestBody, GetHabitsByFrequencyDateDto.class);
            getHabitsByFrequencyDateDto.setRequest(req);
            OperationResultDto result = habitService.getHabitsByFrequency(getHabitsByFrequencyDateDto);
