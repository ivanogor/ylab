...
import homework3.dto.CountHabitCompletionsForPeriodDto;
...
@WebServlet("/habit/countCompletionsForPeriod")
@Slf4j
public class CountHabitCompletionsForPeriodServlet extends BaseHabitServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            log.info("Received request to count habit completions for period: " + requestBody);

            // Десериализация тела запроса
            CountHabitCompletionsForPeriodDto countHabitCompletionsForPeriodDto = objectMapper.readValue(requestBody, CountHabitCompletionsForPeriodDto.class);
            countHabitCompletionsForPeriodDto.setRequest(req);
            OperationResultDto result = habitService.countHabitCompletionsForPeriod(countHabitCompletionsForPeriodDto);
