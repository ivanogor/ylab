...
import homework3.dto.GetHabitsByCreationDateDto;
...
@WebServlet("/habit/getByCreationDate")
@Slf4j
public class GetHabitsByCreationDateServlet extends BaseHabitServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            log.info("Received request to get habits by creation date: " + requestBody);

            // Десериализация тела запроса
            GetHabitsByCreationDateDto getHabitsByCreationDateDto = objectMapper.readValue(requestBody, GetHabitsByCreationDateDto.class);
            getHabitsByCreationDateDto.setRequest(req);
            OperationResultDto result = habitService.getHabitsByCreationDate(getHabitsByCreationDateDto);
