...
import homework3.dto.ResetPasswordDto;
...
@Slf4j
public class ResetPasswordServlet extends BaseUserServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            log.info("Received request to reset password: " + requestBody);

            // Десериализация тела запроса
            ResetPasswordDto resetPasswordDto = objectMapper.readValue(requestBody, ResetPasswordDto.class);
            resetPasswordDto.setRequest(req);
            OperationResultDto result = userService.resetPassword(resetPasswordDto);
