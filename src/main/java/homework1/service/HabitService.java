...
public interface HabitService {
     ...
     */
    List<Habit> getHabitsByCreationDate(GetHabitsByCreationDateDto getHabitsByCreationDateDto);
     ...
     */
    List<Habit> getHabitsByFrequency(GetHabitsByFrequencyDateDto getHabitsByFrequencyDateDto);
